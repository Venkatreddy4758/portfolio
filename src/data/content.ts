  ...
  hobbies: {
    en: {
      ...
      items: [
        ...
        { icon: "badminton", title: "Weekend Badminton", note: "A favourite way to unwind and stay active with friends." },
        { icon: "cricket", title: "Cricket", note: "Weekends on the pitch — bat, ball and good company." },
